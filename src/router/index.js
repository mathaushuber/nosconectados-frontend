...
const routes = [
  ...
  },
  {
    ...
    name: "Solicitacoes",
    component: () =>
      import(/* webpackChunkName: "meus-sensores" */ "../views/Solicitacoes.vue"),
  },
  {
    path: "/atribuicao/:sensorId",
    name: "Atribuicao",
    props: true,
    component: () =>
      import(/* webpackChunkName: "meus-sensores" */ "../views/Atribuicao.vue"),
  },
  {
    ...
    props: true,
    component: () =>
      import(/* webpackChunkName: "edit-sensor" */ "../views/EditSensor.vue"),
  },
];
