                ...
                <div class="col-md-8">
                                ...
                                <div class="card-content mt-3">
                                    ...
                                    <div class="buttons mt-5">
                                        <b-button type="is-primary" tag="router-link"
                                            :to="{ path: '/detalhes/' + sensor.id }">
                                            Detalhes
                                        </b-button>
                                        <b-button type="is-info" tag="router-link"
                                            :to="{ path: '/edit-sensor/' + sensor.id }">
                                            Editar
                                        </b-button>
                                    ...
                                    <p class="is-size-7 is-uppercase has-text-weight-light">Atualizado em: {{
                                        sensor.updated_at.substr(0, 19) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mt-5" v-else>
                        <div class="center imagem">
                            ...
                            <h1 class="is-size-5 center is-uppercase has-text-weight-light">Você não possui nenhum sensor!
                            </h1>
                        </div>
                    </div>
