                ...
                <div class="columns">
                  ...
                  <div class="column">
                    <b-field
                      ...
                      <b-select
                        v-model="sensorData.typeProduction"
                ...
                <div class="columns">
                  <div class="column">
                   <b-field label="Descrição Breve *">
                       <b-input 
                        v-model="sensorData.lowDescription"
                  ...
                  <div class="columns">
                    ...
                    <div class="column">
                      <b-field grouped label="Privacidade *">
                        <b-radio-button v-model="sensorData.isPublic"
                            native-value="0"
                            type="is-danger">
                  ...
                  <div class="columns">
                    ...
                    <b-field
                      ...
                      <b-select
                        ...
                        :disabled="!sensorData.state"
                        v-model="sensorData.city"
                        expanded>
                        <option v-if="!sensorData.state" value=""
                  ...
                  <div class="columns">
                    <div class="column">
                      ...
                      <b-button
                        type="is-success" @click="doUpdate">
                        Atualizar
                      </b-button>
                      </div>
                    </div>
