    ...
    <main>
        <div class="columns">
            <div class="container is-fluid">
                <div class="column is-one-third mt-5 menu">
                    <div class="center">
                        <img src="../assets/sensorespublicos.svg" width="250" height="130">
                    </div>
                    <h1 class="is-size-6 is-uppercase has-text-weight-light pb-2 mt-4 center">
