          ...
          <div class="card mt-4 "><!--Início card-->
            <div class="card-content"><!--Início card-content-->
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="Nome">
                    <b-input placeholder="Nome" :value="userData.firstName" type="text"
                ...
                <div class="column">
                  <b-field label="Sobrenome">
                    <b-input placeholder="Sobrenome" :value="userData.lastName" type="text"
                      validation-message="Entre com um nome válido" pattern="[A-ZA-z çâêîôûáéíóúàèìòùãẽĩõũ]*"
                      minlength="3" maxlength="255">
                    </b-input>
                  </b-field>
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="CPF *">
                    <b-input disabled type="text" :value="userData.document" placeholder="CPF"
                ...
                <div class="column">
                  <b-field label="Gênero *">
                    <b-select :value="userData.gender" placeholder="Selecione o gênero" expanded>
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="Email *">
                    <b-input :value="userData.email" placeholder="Email" type="email">
                    </b-input>
                  </b-field>
                  <b-tag v-if="tagEmail && userData.registerConfirmed === 0" close-type='is-danger' attached closable
                    aria-close-label="Close tag" @close="tagEmail = false">
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="Perfil do Facebook">
                    <b-input :value="userData.facebookProfile" placeholder="URL" type="url">
                    </b-input>
                  </b-field>
                </div>
              </div>
              <div class="columns">
                ...
                <div class="column">
                  <b-field label="Telefone">
                    <b-input :value="userData.phone" type="text" placeholder="Fone"
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="CEP">
                    <b-input type="text" :value="userData.zipcode" placeholder="CEP"
                ...
                <div class="column">
                  <b-field label="Bairro">
                    <b-input type="text" :value="userData.neighborhood" maxlength="64" minlength="3" placeholder="Bairro">
                    </b-input>
                  </b-field>
                </div>
              </div>
              <div class="columns">
                <div class="column is-6">
                  <b-field label="Rua">
                    <b-input :value="userData.street" type="text" maxlength="64" minlength="3" placeholder="Rua">
                    </b-input>
                  </b-field>
                </div>
                <div class="column">
                  <b-field label="Número">
                    <b-input type="text" maxlength="64" minlength="3" :value="userData.numberU" placeholder="Número"
                ...
                <div class="column">
                  <b-field label="Complemento">
                    <b-input type="text" maxlength="64" minlength="3" placeholder="Complemento">
                    </b-input>
                  </b-field>
                </div>
              </div>
              <div class="columns">
                <div class="column">
                  <b-field label="Estado">
                    <b-select placeholder="Selecione o estado" @input="loadMunicipios" v-model="estadoTemp" expanded>
                ...
                <div class="column">
                  <b-field label="Municipio">
                    <b-select placeholder="Selecione o municipio" :disabled="!estadoTemp" expanded>
                      <option v-if="!estadoTemp" value="">Selecione o estado primeiro
                      </option>
              ...
              <div class="columns">
                <div class="column">
                  <b-field label="Senha">
                    <password maxlength="60" v-model="passwordTemp" :secureLength="8">
                    </password>
                  </b-field>
                </div>
                <div class="column">
              ...
              <div class="columns">
                <div class="column">
                  <div class="buttons is-justify-content-right">
                    ...
                    <b-button v-if="userData.isAdmin == 0" type="is-danger">
                      Excluir
                    </b-button>
                  </div>
                </div>
