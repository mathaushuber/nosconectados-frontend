                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="content">
                                    ...
                                    <b-tag v-if="usuario.isAdmin === 1" type="is-success"
                                        icon="account-check">Administrador</b-tag>
                            ...
                            <div class="card-content">
                                ...
                                <div class="content">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <b-button class="ml-3" type="is-danger" icon-right="delete"
                                            @click="confirmDadoDelete(sensor.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        ...
                                        <p v-if="sensorAll.isPublic === 1">Público: <b-icon icon="check"
                                                type="is-success"></b-icon></p>
                                        ...
                                        <p>Status: <b-icon v-if="sensorAll.isActive == 0" icon="access-point-remove"
                                            ...
                                            <b-icon v-else icon="access-point-off" type="is-warning"></b-icon>
                                        </p>
                                ...
                                <div class="content">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <b-button class="ml-3" type="is-danger" icon-right="delete"
                                            @click="confirmSensorDelete(sensorAll.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        ...
                                        <p v-if="sensor.isPublic === 1">Público: <b-icon icon="check"
                                                type="is-success"></b-icon></p>
                                        <p v-else>Público: <b-icon icon="remove" type="is-danger"></b-icon></p>
                                ...
                                <div class="content">
                                    ...
                                    <div class="buttons">
                                        <p class="mt-2">Criado em: {{ sensor.created_at }} </p>
                                        <b-button class="ml-3" type="is-danger" icon-right="delete"
                                            @click="confirmSensorDelete(sensor.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        ...
                                        <b-tag v-if="atribuicaoUse.isAdminSensor === 2"
                                            type="is-success">Administrador</b-tag>
                                        <b-tag v-if="atribuicaoUse.isAdminSensor === 1" type="is-info">Patrocinador</b-tag>
                                        <b-tag v-if="atribuicaoUse.isAdminSensor === 0"
                                            type="is-warning">Visualizador</b-tag>
                                    </div>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <b-button class="ml-3" type="is-danger" icon-right="delete"
                                            @click="confirmAtribuicaoDelete(atribuicaoUse.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        ...
                                        <p>Endereço: {{ localizacao.street }} {{ localizacao.numberU }} {{
                                            localizacao.complement }}</p>
                                ...
                                <div class="content">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <b-button class="ml-3" type="is-danger" icon-right="delete"
                                            @click="confirmLocalizacaoDelete(localizacao.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="columns mt-5">
                                    <div class="column">
                                        <b-message title="Exportação dos dados" aria-close-label="Close message">
                                            Para exportar os dados do banco de dados da aplicação basta clicar no item do
                                            menu "Exportar"!
                                    ...
                                    <div class="column">
                                        <b-message title="Gerenciando os dados" aria-close-label="Close message">
                                            Pelo painel do administrador é possível gerenciar todos os dados do banco de
                                            dados, sem a necessidade de utilizar comandos
                                ...
                                <div class="columns">
                                    <div class="column">
                                        <b-message title="Minha conta" aria-close-label="Close message">
                                            Como administrador só é possível remover sua conta diretamente no painel, as
                                            informações de perfil somente podem editá-las. Não é possível remover outros
                                            administradores por aqui!
                                        </b-message>
                                    </div>
                                    <div class="column">
                                        <b-message type="is-warning" title="Atenção!" aria-close-label="Close message">
                                            Tome cuidado ao apagar informações relevantes para a plataforma, atenção ao
                                            remover chaves estrangeiras nas tabelas referenciadas, todas as ações aqui
                                            requerem cautela!
                                        </b-message>
                                    </div>
                                </div>
                        ...
                        <div class="card mt-3">
                            <div class="card-content">
                                ...
                                <div class="content">
                                    ...
                                    <br>
                                    <p class="is-size-7 center is-uppercase has-text-weight-light mt-2">Criado em: {{
                                        userData.created_at_user }} </p>
                                    <div class="buttons">
                                        <div class="buttons">
                                            <b-button class="ml-3" type="is-danger" icon-right="delete"
                                                @click="confirmAdminDelete(userData.id)">
                                                Excluir
                                            </b-button>
                                            <b-button tag="router-link" :to="{ path: '/edit-perfil' }" class="ml-3"
                                                type="is-primary" icon-right="account-edit">
                                                Editar
                                            </b-button>
                                        </div>
                                    </div>
...
<script>
import {
    getUsers, getUser, listaSensores, getAllSensores, getInformationSensors, getAtribuicoes, getLocalizacoes, removeUsuario, removeDadoSensor,
    removeSensor, removeAtribuicao, removeLocalizacao
} from "../services/api";
