            ...
            <div class="row">
                <div class="col-md-4 mt-5">
                    ...
                    <div class="mt-5 ml-3">
                        ...
                        <b-field label="Estado">
                            <b-select placeholder="Selecione o estado" expanded rounded icon="home-group"
                                @input="loadMunicipios" v-model="state">
                        ...
                        <b-field label="Cidade">
                            <b-select placeholder="Selecione a cidade" expanded rounded icon="city" v-model="city"
                                :disabled="!state">
                                <option v-if="!state" value="">Selecione o estado primeiro
                                </option>
                        ...
                        <b-field label="Produção">
                            <b-select placeholder="Tipo de produção" expanded rounded icon="sprout"
                        ...
                        <div class="buttons is-justify-content-right">
                            <b-button @click="clearFilter" type="is-primary">
                                Limpar
                                <b-icon icon="filter-remove-outline" size="is-small" class="ml-1">
                                </b-icon>
                            </b-button>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <div class="col-md-12 mt-3">
                        <b-pagination class="mr-3" :total="total" v-model="current" :range-before="rangeBefore"
                            :range-after="rangeAfter" :order="order" :size="size" :simple="isSimple" :rounded="isRounded"
                            :per-page="perPage" :icon-prev="prevIcon" :icon-next="nextIcon" aria-next-label="Next page"
                            aria-previous-label="Previous page" aria-page-label="Page" aria-current-label="Current page"
                            :page-input="hasInput" :page-input-position="inputPosition"
                                ...
                                <div class="card-content mt-3">
                                    ...
                                    <div class="center mt-5">
                                        <b-button type="is-primary" tag="router-link"
                                            :to="{ path: '/atribuicao/' + sensor.id }">
                                            Atribuir
                                        </b-button>
                                    </div>
                                    <p class="is-size-7 is-uppercase has-text-weight-light mt-3">Atualizado em: {{
                                        sensor.updated_at }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 mt-5" v-else>
                        <div class="center imagem">
                            <img src="../assets/solicitacoes-null.svg" />
                            <h1 class="is-size-5 center is-uppercase has-text-weight-light">Nenhum sensor solicitado!</h1>
                        </div>
                    </div>
...
<script>
import { sensoresSolicitados } from "../services/api";
